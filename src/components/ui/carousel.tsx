...
const CarouselControl = ({
  ...
  return (
    <button
      className={`mx-2 flex h-10 w-10 items-center justify-center rounded-full border border-neutral-700 bg-neutral-900/80 backdrop-blur-sm focus:border-[#6D64F7] focus:outline-none hover:-translate-y-0.5 hover:bg-neutral-800 active:translate-y-0.5 transition duration-200 ${
